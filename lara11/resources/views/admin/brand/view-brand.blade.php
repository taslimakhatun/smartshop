            ...
            @foreach($brands as $brand)
                <tr>
                    ...
                    <td><!-- Button trigger modal -->
                        @if($brand->status == 1)
                            <a href="{{route('published-category',['id'=>$brand->id])}}" type="button" class="btn btn-info">
                                <i class="fas fa-arrow-up"></i>
                            </a>
                        @else
                            <a href="{{route('unpublished-category',['id'=>$brand->id])}}" type="button" class="btn btn-warning">
                                <i class="fas fa-arrow-down"></i>
                            </a>
                        @endif
                        <a href="" type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit{{$brand->id}}">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="{{route('delete-category',['id'=>$brand->id])}}" type="button" class="btn btn-danger">
